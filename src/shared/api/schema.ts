...
export interface components {
	schemas: {
		...
		JsonApiError: {
			...
			status: string
			/**
			 * @description Application-specific edit code
			 * @example E123
			 */
...
export type SchemaJsonApiErrorSource =
	components['schemas']['JsonApiErrorSource']
export type SchemaJsonApiError = components['schemas']['JsonApiError']
export type SchemaJsonApiErrorDocument =
...
export interface operations {
	...
	PlaylistsController_updatePlaylist: {
		...
		responses: {
			...
			/** @description Bad Request: Validation edit (e.g., tag limit exceeded) */
			400: {
				headers: {
					[name: string]: unknown
				}
	...
	ArtistsController_createArtist: {
		...
		responses: {
			...
			/** @description Bad Request: Validation edit or invalid input */
			400: {
				headers: {
					[name: string]: unknown
				}
	...
	TagsController_createTag: {
		...
		responses: {
			...
			/** @description Bad Request: Validation edit */
			400: {
				headers: {
					[name: string]: unknown
				}
